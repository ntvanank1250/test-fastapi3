...
from api import crud, utils,config
...
async def sign_up(request: Request, name: str = Form(...), email: str = Form(...), password: str = Form(...), re_password: str = Form(...), db: Session = Depends(utils.get_db)):
